        ...
        <div className="bg-white rounded-xl p-6 mb-6 shadow-sm">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-4">
              <button onClick={() => router.back()} className="text-gray-700 hover:text-gray-900 text-2xl font-bold rounded-full hover:bg-gray-100 hover:shadow-md" >
                ←
              </button>
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Social Media Assistant</h1>
                <p className="text-gray-600 text-sm">
                  Fresher • Full-Time • 1n2b3v
                </p>
              </div>
            </div>
