        ...
        <div className="p-6">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ref={confirmRef}
              onClick={onConfirm}
              className="px-4 py-2 text-sm font-medium text-white bg-teal-600 hover:bg-teal-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
            >
              {confirmText}
            </button>
          </div>
