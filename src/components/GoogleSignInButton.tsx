...
interface Props {
  text: string;
  onClick?: () => void; // Thêm prop onClick để xử lý logic
}

export default function GoogleSignInButton({ text, onClick }: Props) {
  return (
      ...
      <div className={styles['gsi-material-button-content-wrapper']}>
        <div className={styles['gsi-material-button-icon']}>
          <svg 
            ...
            viewBox="0 0 48 48" 
            // CHUYỂN ĐỔI: 'xmlns:xlink' -> 'xmlnsXlink' (camelCase)
            xmlnsXlink="http://www.w3.org/1999/xlink" 
            // CHUYỂN ĐỔI: 'style="..."' -> 'style={{...}}'
            style={{ display: 'block' }}
          >
        ...
        {/* Dùng prop 'text' để hiển thị nội dung */}
